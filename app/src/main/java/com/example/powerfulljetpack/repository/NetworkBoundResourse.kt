...
import com.example.powerfulljetpack.util.ErrorHandling
import com.example.powerfulljetpack.util.ErrorHandling.Companion.ERROR_CHECK_NETWORK_CONNECTION
import com.example.powerfulljetpack.util.ErrorHandling.Companion.ERROR_UNKNOWN
import com.example.powerfulljetpack.util.ErrorHandling.Companion.UNABLE_TODO_OPERATION_WO_INTERNET
        ...
        if (isNetworkRequest) {
            if (isNetworkAvailable) {
                coroutineScope.launch {
                    ...
                    //addSource should be actioned on Main thread
                    withContext(Main) {
